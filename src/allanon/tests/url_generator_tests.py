...
class UrlGeneratorTest(unittest.TestCase):
    ...
    def test_range(self):
        ...
        self.assertEqual(
            results,
            [("foo 3 bar", [3], [1]), ("foo 4 bar", [4], [1]), ("foo 5 bar", [5], [1])],
        )
    ...
    def test_revert(self):
        ...
        self.assertEqual(
            results,
            [("foo 4 bar", [4], [1]), ("foo 3 bar", [3], [1]), ("foo 2 bar", [2], [1])],
        )
    ...
    def test_multiple_many(self):
        ...
        self.assertEqual(
            results,
            [
                ("foo 3 bar 5 baz 0 qux 143", [3, 5, 0, 143], [1, 1, 1, 3]),
                ("foo 3 bar 5 baz 1 qux 143", [3, 5, 1, 143], [1, 1, 1, 3]),
                ("foo 3 bar 6 baz 0 qux 143", [3, 6, 0, 143], [1, 1, 1, 3]),
                ("foo 3 bar 6 baz 1 qux 143", [3, 6, 1, 143], [1, 1, 1, 3]),
                ("foo 4 bar 5 baz 0 qux 143", [4, 5, 0, 143], [1, 1, 1, 3]),
                ("foo 4 bar 5 baz 1 qux 143", [4, 5, 1, 143], [1, 1, 1, 3]),
                ("foo 4 bar 6 baz 0 qux 143", [4, 6, 0, 143], [1, 1, 1, 3]),
                ("foo 4 bar 6 baz 1 qux 143", [4, 6, 1, 143], [1, 1, 1, 3]),
            ],
        )
...
class DynamicURLGenerationTest(unittest.TestCase):
    def test_urls(self):
        self.assertEqual(
            tuple(get_dynamic_urls(("http://host1/{1:2}/?param={3:4}",))),
            (
